...
```bash
python -m python_demo_test.agent_input_framework_mvp.run_chat_completions_adapter_demo \
...
```bash
python -m python_demo_test.agent_input_framework_mvp.run_tool_schema_demo \
...
```bash
python -m python_demo_test.agent_input_framework_mvp.run_engine_loop_demo \
...
```bash
python -m python_demo_test.agent_input_framework_mvp.run_arrange_n_turn_demo \
  --turns 3 \
...
```bash
python -m python_demo_test.agent_input_framework_mvp.run_sse_live_demo \
